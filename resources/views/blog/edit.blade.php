...
<div class="mx-auto p-5 text-center">
    <h1 class="fw-bold display-4">Edit Topic</h1>
</div>
...
>
    ...
    @method('PUT')
        <div class="form-group">
            ...
            <br>
            <div class="col-sm-10">
                <input class="form-control form-control-lg" type="text" name="title" value="{{$post->title}}" placeholder="Title">
            </div>
        </div>
        <div class="form-group">
        <br>
            <label for="exampleFormControlTextarea1" class="display-6">Subject</label>
            <textarea class="form-control" type="text" name="description" rows="5">{{$post->description}}</textarea>
            <br>
        </div>
        <div class="form-group">
